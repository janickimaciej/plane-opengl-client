...
(
	...
	float fuselageFrontArea, float fuselageFrontDragCoef, const glm::vec3& fuselageFrontDragPoint,
	float fuselageSideArea, float fuselageSideDragCoef, const glm::vec3& fuselageSideDragPoint,
