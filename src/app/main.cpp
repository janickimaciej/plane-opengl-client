...
void resizeWindow(GLFWwindow* window, int width, int height)
{
	...
	window; //tmp (warning suppression)
	//Graphics::WindowPayload* windowPayload =
	//	(Graphics::WindowPayload*)glfwGetWindowUserPointer(window);
...
void processInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_5) == GLFW_PRESS ||
		glfwGetKey(window, GLFW_KEY_KP_5) == GLFW_PRESS)
	{
	...
	if (glfwGetKey(window, GLFW_KEY_7) == GLFW_PRESS ||
		glfwGetKey(window, GLFW_KEY_KP_7) == GLFW_PRESS)
	{
		//windowPayload->scene->ctrlThrust(0.7f);
	}
	if (glfwGetKey(window, GLFW_KEY_8) == GLFW_PRESS ||
		glfwGetKey(window, GLFW_KEY_KP_8) == GLFW_PRESS)
	{
	...
	if (glfwGetKey(window, GLFW_KEY_SLASH) == GLFW_PRESS ||
		glfwGetKey(window, GLFW_KEY_KP_DIVIDE) == GLFW_PRESS)
	{
